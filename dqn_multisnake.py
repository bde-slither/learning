...
class AtariProcessor(Processor):
    def process_observation(self, observation):
        ...
        img = observation #Image.fromarray(observation)
...
parser.add_argument('--env-name', type=str, default='multisnake-v0')
...
#if args.env_name == "ball_paddle-v0" or args.env_name == "multisnake-v0":
  #  env.set_obs_type("Image")
np.random.seed(123)
env.seed(123)
nb_actions = env.action_space.n
#nb_actions = env.action_space.spaces[0]
